...
const CategoryButtons = () => {
  ...
  return (
    ...
    //   {!isPanelOpen && (
    //     <button
    //       className="flex items-center justify-between text-white bg-blue-500 sm:mr-80 sm:ml-44 md:-mr-3 hover:bg-blue-600 font-bold px-6 py-3 rounded-full fixed right-4 top-4 mt-20 z-50 shadow-lg transition-all duration-300"
    //       onClick={() => setIsPanelOpen(true)}
    //     >
    //       دسته‌بندی محصولات
    ...
    //   {/* Slide-out panel */}
    //   <div
    //     className={`fixed top-0 right-0 w-72 h-full bg-white shadow-2xl transform transition-transform duration-700 ease-in-out z-40 sm:mr-[310px] md:-mr-2 ${isPanelOpen ? "translate-x-0" : "translate-x-full"
    //       }`}
    //   >
    //     <div className="p-5 ">
    //       {/* Close button */}
    ...
    //   {!isPanelOpen && (
    //     <button
    //       className="flex items-center justify-between text-white bg-blue-500 sm:mr-48 sm:ml-44 md:-mr-3 hover:bg-blue-600 font-bold px-6 py-3 rounded-full fixed right-4 top-4 mt-20 z-50 shadow-lg transition-all duration-300"
    //       onClick={() => setIsPanelOpen(true)}
    //     >
    //       دسته‌بندی محصولات
    //       <img src="imgs/site-icons/category.png" className="w-6 ml-2" alt="Categories" />
    ...
    //   {/* Slide-out panel */}
    //   <div
    //     className={`fixed top-0 right-0 w-full sm:w-72 sm:mr-36 md:-mr-3 h-full bg-white shadow-2xl transform transition-transform duration-700 ease-in-out z-40 ${isPanelOpen ? "translate-x-0" : "translate-x-full"
    //       }`}
    //   >
    //     <div className="p-5">
    //       {/* Close button */}
    ...
    <div className="relative">
      ...
      {/* Slide-out panel */}
      <div
        className={`fixed top-0 right-0 w-full sm:w-72 h-full bg-white shadow-2xl transform transition-transform duration-700 mr- ease-in-out z-40 ${isPanelOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        <div className="p-5">
          {/* Close button */}
          <button
