      ...
      {currentItems.length === 0 ? (
        <div className='flex justify-center items-center -mt-10'>
          <div className="text-center">
            <img src="imgs/site-icons/order.webp" className='w-96 mx-auto' alt="Empty Cart" />
        ...
        <div>
          <div className="flex justify-end mb-6">
            <div className="border-2 border-gray-300 w-full max-w-3xl rounded-lg shadow-lg p-6 bg-white">
              {currentItems.map((item) => (
                  ...
                  <div className="mt-4 flex justify-between items-center">
                      ...
                      <div>
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="bg-red-500 text-white px-3 py-2 rounded-lg shadow hover:bg-red-600 transition"
                          >
                            -
                          </button>
                          <input
                    ...
                    <div className="flex space-x-4">
                      <button
                        ...
                        className="flex justify-center items-center text-gray-600 hover:text-gray-800 transition"
                      >
                        <img src="imgs/site-icons/edit.png" className="w-8 h-8 hover:scale-110 transition-transform" alt="Edit" />
                      </button>
                      <button
                        onClick={() => handleDeleteClick(item)}
                        className="flex justify-center items-center text-gray-600 hover:text-red-600 transition"
                      >
          ...
          <div className="border shadow-lg shadow-gray-300 w-full max-w-lg p-6 rounded-xl bg-white mt-10">
